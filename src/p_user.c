...
consvar_t cv_cam_gamepadsensitivity = CVAR_INIT ("cam_gamepadsensitivity", "1", CV_FLOAT|CV_SAVE|CV_ALLOWLUA, sensitivity_cons_t, NULL);
...
consvar_t cv_cam2_gamepadsensitivity = CVAR_INIT ("cam2_gamepadsensitivity", "1", CV_FLOAT|CV_SAVE|CV_ALLOWLUA, sensitivity_cons_t, NULL);
